...
import {temperatureList} from './constant'

const step = 360 / temperatureList.length;
...
class Temperature extends Component {
  ...
  adjustRotateAndTemperature(rotate) {
    const index = parseInt(rotate / step);
    return {
      index: index,
                         ...
                         if (isMove) {
                           ...
                           this.setState({
                             ...
                             if (this.props.onChange) {
                               const {index, temperature} = this.adjustRotateAndTemperature((540 - a - adjustAngle) % 360);
                               this.props.onChange(temperature, index);
                               onFetch && onFetch();
                             }
                           });
                         }
